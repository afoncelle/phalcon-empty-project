...
<table style="min-width:320px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#eaeced">
    ...
    <tr>
        <td class="wrapper" align="center" style="padding:0 10px;">
            <!-- module 1 -->
            <table data-module="module-1" width="600" cellpadding="0" cellspacing="0">
                <tr>
                    <td data-bgcolor="bg-module" bgcolor="#eaeced">
                        <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding:0;background-color: black">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <th class="" width="50" align="center" style="padding:0;">
                                                <table class="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="line-height:0;padding:4px 10px">
                                                            <a target="_blank" style="text-decoration:none;" href="{{ sitebaseurl }}/"><img src="{{ sitebaseurl }}/img/layout/logo-el.gif" width="30"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                                            <th class="" align="left" style="padding:0 50px 0 0;" >
            ...
            <!-- module 2 -->
            <table data-module="module-2" width="600" cellpadding="0" cellspacing="0">
                <tr>
                    <td data-bgcolor="bg-module" bgcolor="#eaeced">
                        <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="img-flex"><img src="{{ sitebaseurl }}/img/layout/bg-email.jpg" style="vertical-align:top;max-width: 100%" width="600" height="300" alt="" /></td>
                            </tr>
                            <tr>
            ...
            <!-- module 3 -->
            <table data-module="module-3" width="600" cellpadding="4" cellspacing="0">
                <tr>
                    <td data-bgcolor="bg-module" align="center" bgcolor="#eaeced" style=" color:#666; padding:0;background-color: #fff;font:10px/14px Arial, Verdana, sans-serif;">
                        Copyright Earth Legacy &copy;{{ date('Y') }}
                    </td>
                </tr>
            </table>
        </td>
